...
# Comparing the two classifiers to all other classifiers on Sklearn
names = [
    "Nearest Neighbors",
    "Linear SVM",
    "RBF SVM",
...
print("The highest accuracy is {} for The {} classifier".format(highest_score, best_classifier))
plt.tight_layout()
plt.show()